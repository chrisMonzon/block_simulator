...
int amountinit = 5;
int w = 750, h = 500 ; // width and height 
...
enum shape {cube, sphere, teapot, point} ;
...
EXTERN GLuint vao2;
EXTERN GLuint vao3;
EXTERN GLuint lenght;
EXTERN GLuint length2;
EXTERN GLuint length3;
EXTERN GLuint currz;
EXTERN GLuint visObjects;
EXTERN vec4 colors[11];
EXTERN GLuint currColor;
static enum {trans, resize, rot} mode ;
EXTERN float offx ; 
EXTERN float offy ; 
EXTERN float offz ; 
